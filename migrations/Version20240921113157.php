 ...
 */
final class Version20240921113157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `member` (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, fonction VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, social_link_one VARCHAR(255) DEFAULT NULL, social_link_two VARCHAR(255) DEFAULT NULL, social_link_three VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, email VARCHAR(120) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
